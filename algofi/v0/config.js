...
exports.assetIdToAssetName = exports.marketCounterToAssetName = exports.orderedSupportedMarketAppIds = exports.orderedMarketAppIds = exports.orderedOracleAppIds = exports.PARAMETER_SCALE_FACTOR = exports.REWARDS_SCALE_FACTOR = exports.SCALE_FACTOR = exports.SECONDS_PER_YEAR = exports.foreignAppIds = exports.assetDictionary = exports.managerAddress = exports.protocolManagerAppId = exports.orderedAssetsAndPlaceholders = exports.extraAssets = exports.orderedAssets = void 0;
exports.orderedAssets = ["ALGO", "USDC", "goBTC", "goETH", "STBL"];
exports.extraAssets = ["BANK"];
exports.orderedAssetsAndPlaceholders = [
    "ALGO",
    "USDC",
    "goBTC",
    "goETH",
...
exports.protocolManagerAppId = 465818260;
exports.managerAddress = "2SGUKZCOBEVGN3HPKSXPS6DTCXZ7LSP6G3BQF6KVUIUREBBY2QTGSON7WQ";
exports.assetDictionary = {
    ALGO: {
        decimals: 6,
        marketCounter: 1,
...
exports.foreignAppIds = [465814065, 465814103, 465814149, 465814222, 465814278];
exports.SECONDS_PER_YEAR = 60 * 60 * 24 * 365;
exports.SCALE_FACTOR = 1e9;
exports.REWARDS_SCALE_FACTOR = 1e14;
exports.PARAMETER_SCALE_FACTOR = 1e3;
...
for (var _i = 0, orderedAssets_1 = exports.orderedAssets; _i < orderedAssets_1.length; _i++) {
    var assetName = orderedAssets_1[_i];
    orderedOracleAppIds.push(exports.assetDictionary[assetName]["oracleAppId"]);
    orderedSupportedMarketAppIds.push(exports.assetDictionary[assetName]["marketAppId"]);
    marketCounterToAssetName[exports.assetDictionary[assetName]["marketCounter"]] = assetName;
    assetIdToAssetName[exports.assetDictionary[assetName]["underlyingAssetId"]] = assetName;
    assetIdToAssetName[exports.assetDictionary[assetName]["bankAssetId"]] = "b" + assetName;
}
for (var _a = 0, extraAssets_1 = exports.extraAssets; _a < extraAssets_1.length; _a++) {
    var assetName = extraAssets_1[_a];
    assetIdToAssetName[exports.assetDictionary[assetName]["underlyingAssetId"]] = assetName;
}
for (var _b = 0, orderedAssetsAndPlaceholders_1 = exports.orderedAssetsAndPlaceholders; _b < orderedAssetsAndPlaceholders_1.length; _b++) {
    var assetName = orderedAssetsAndPlaceholders_1[_b];
    orderedMarketAppIds.push(exports.assetDictionary[assetName]["marketAppId"]);
}
